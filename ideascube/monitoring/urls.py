...
urlpatterns = [
    ...
    url(r'^stock/export/$', views.stock_export, name='stock_export'),
    url(r'^stock/import/$', views.stock_import, name='stock_import'),
    ...
    url(r'^stock/inventory/(?P<pk>[\d]+)/delete/$', views.inventory_delete, name='inventory_delete'),  # noqa
