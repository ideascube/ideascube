    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('camp_activities', ideastube.fields.CommaSeparatedCharField(blank=True, max_length=512, verbose_name='Activities in the camp', choices=[(b'1', 'Comitees, representation groups'), (b'2', 'Music, dance, singing'), (b'3', 'Other cultural activities'), (b'4', 'Informatic workshops'), (b'5', 'Literacy working group'), (b'6', 'Talking group'), (b'7', 'Recreational'), (b'8', 'Volunteering'), (b'9', 'Psycosocial'), (b'10', 'Educational'), (b'11', 'Sport')])),
                ('camp_address', models.CharField(max_length=200, verbose_name='Address in the camp', blank=True)),
                ('en_level', ideastube.fields.CommaSeparatedCharField(blank=True, max_length=32, verbose_name='English knowledge', choices=[(b'u', 'Understood'), (b'w', 'Written'), (b's', 'Spoken'), (b'r', 'Read')])),
                ('ar_level', ideastube.fields.CommaSeparatedCharField(blank=True, max_length=32, verbose_name='Arabic knowledge', choices=[(b'u', 'Understood'), (b'w', 'Written'), (b's', 'Spoken'), (b'r', 'Read')])),
                ('rn_level', ideastube.fields.CommaSeparatedCharField(blank=True, max_length=32, verbose_name='Kirundi knowledge', choices=[(b'u', 'Understood'), (b'w', 'Written'), (b's', 'Spoken'), (b'r', 'Read')])),
                ('fr_level', ideastube.fields.CommaSeparatedCharField(blank=True, max_length=32, verbose_name='French knowledge', choices=[(b'u', 'Understood'), (b'w', 'Written'), (b's', 'Spoken'), (b'r', 'Read')])),
                ('sw_level', ideastube.fields.CommaSeparatedCharField(blank=True, max_length=32, verbose_name='Swahili knowledge', choices=[(b'u', 'Understood'), (b'w', 'Written'), (b's', 'Spoken'), (b'r', 'Read')])),
            ],
            options={
