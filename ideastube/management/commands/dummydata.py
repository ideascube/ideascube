...
from ideastube.library.tests.factories import BookSpecimenFactory, BookFactory
from ideastube.mediacenter.tests.factories import DocumentFactory
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        ContentFactory(title='1937 world flight', text=text, summary=text,
                       ...
                       tags=['plane', 'aviation'],
                       image__from_path='ideastube/tests/data/amelia-earhart.jpg')  # noqa
        ...
        ContentFactory(title=title, text=text, summary=text,
                       ...
                       image__from_path='ideastube/tests/data/plane.jpg')
        ...
        summary = ("If one chanced to examine the catalogues of Kingsbridge "
                   ...
                   "place.")
        path = 'ideastube/tests/data/deering-of-deal.jpg'
        ...
        summary = (u"Le roman raconte les aventures d'un Gascon impécunieux "
                   ...
                   u"Anne d'Autriche.")
        path = 'ideastube/tests/data/les-trois-mousquetaires.jpg'
        ...
        summary = ("With the title of Sense and Sensibility is connected one "
                   ...
                   "novel.")
        path = 'ideastube/tests/data/sense-and-sensibility.jpg'
        ...
        path = 'ideastube/tests/data/the-prophet.jpg'
        ...
        path = 'ideastube/tests/data/declaration-1789.pdf'
        DocumentFactory(title=title, original__from_path=path, summary=summary,
                        tags=['history', 'France'])
        path = 'ideastube/tests/data/amelia-earhart.jpg'
