...
from ideastube.decorators import staff_member_required
from ideastube.library.models import Book
from ideastube.mediacenter.models import Document
...
class ByTag(ListView):
    template_name = 'ideastube/by_tag.html'
    paginate_by = 20
...
class UserList(ListView):
    model = user_model
    template_name = 'ideastube/user_list.html'
...
class UserDetail(DetailView):
    model = user_model
    template_name = 'ideastube/user_detail.html'
...
class UserUpdate(UserFormMixin, UpdateView):
    model = user_model
    template_name = 'ideastube/user_form.html'
    context_object_name = 'user_obj'
    form_class = UserForm
...
class UserDelete(DeleteView):
    model = user_model
    template_name = 'ideastube/user_confirm_delete.html'
    context_object_name = 'user_obj'
...
class SetPassword(FormView):
    ...
    template_name = 'ideastube/set_password.html'
...
class AjaxProxy(View):
    ...
    def get(self, *args, **kwargs):
        ...
        headers = {
            'User-Agent': 'ideastube +http://ideas-box.org'
        }
